    ...
    <div class="stepper-panel">
      ...
      <div class="stepper-panels py-8">
        ...
        <div class="stepper-quest">
          ...
          <p class="font-semibold">5. Use instructional materials (audio/video materials: field trips, film showing, computer aided instruction and etc.) to reinforce learning process.</p>
          
           <div class="buttons">
            <button :id="[`index5`]" v-on:click="chose(5, 5, 20)" class="">5. Outstanding</button>
            <button :id="[`index4`]" v-on:click="chose(4, 5, 20)" class="">4. Very Satisfaction</button>
            <button :id="[`index3`]" v-on:click="chose(3, 5, 20)" class=""> 3. Satisfaction</button>
            <button :id="[`index2`]" v-on:click="chose(2, 5, 20)" class="">2. Fair</button>
            <button :id="[`index1`]" v-on:click="chose(1, 5, 20)" class="">1. Poor</button>
...
const scoredata = {"eval_score": score,
    ...
    submitForm() {
      ...
      // alert(this.notice);
          ...
          window.location.href = window.location.origin + '/Comments?ratingPeriod='+ this.$route.query.ratingPeriod +'&evaluatee='+this.$route.query.evaluatee+'&evaluationType='+this.$route.query.evaluationType;
        }
    },
  }
}
