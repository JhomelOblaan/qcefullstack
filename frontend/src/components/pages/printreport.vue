    ...
    <Sidebarmob /> 
         <div class="flex px-10">
            <div class="container mt-12 ml-8">
                 <div class="grid grid-cols-1 gap-6 mb-6 lg:grid-cols-4 gap-20">
                    <div class="w-full px-4 py-5 bg-white rounded-lg shadow" >
                        <div class="grid grid-rows-1 grid-flow-col">
                         ...
                         <div class="">
                            ...
                            <div class=" mt-4"><a href="http://localhost:3000/overallreport/qce-over-all/pdf"><button style="border: none;" class="bg-green-400 h-10 text-xs text-center p-2">Print Report</button></a></div>
