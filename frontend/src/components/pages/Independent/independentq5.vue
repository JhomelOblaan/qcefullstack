    ...
    <div class="stepper-panel">
      ...
      <div class="stepper-panels py-8">
        ...
        <div class="stepper-quest">
          ...
          <p class="font-semibold">5. Encourages students to learn beyond what is required and help/guide the students how to apply the concepts learned.</p>
          
          
            <div class="buttons">
            <button :id="[`index5`]" v-on:click="chose(5, 5, 15)" class="">5. Outstanding</button>
            <button :id="[`index4`]" v-on:click="chose(4, 5, 15)" class="">4. Very Satisfaction</button>
            <button :id="[`index3`]" v-on:click="chose(3, 5, 15)" class=""> 3. Satisfaction</button>
            <button :id="[`index2`]" v-on:click="chose(2, 5, 15)" class="">2. Fair</button>
            <button :id="[`index1`]" v-on:click="chose(1, 5, 15)" class="">1. Poor</button>
            </div>
